...
public class Knight extends ChessPiece{
	...
	public Knight(int initX, int initY, String teamColor) {
		// TODO Auto-generated constructor stub
		super(320,320, initX, initY, teamColor);
		pieceColor = teamColor;
		if(teamColor.equals("black")) {
			img_file = "blackknight.png";
		} else {
			img_file = "whiteknight.png";
		}
	...
	public Set<Tile> possibleMoves(Tile[][] boardTiles, Set<ChessPiece> boardPieces){
		...
		for(int i = 0; i<8; i++) {
			for(int j = 0; j<8; j++) {
				...
				if((Math.abs(this.getX() - t.getX()) == 2 
						&& Math.abs(this.getY() - t.getY()) == 2)
